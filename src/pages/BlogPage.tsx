      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 md:px-12 py-12 sm:py-16 space-y-8">
        <div className="space-y-6">
          {publicArticles.length === 0 ? (
            <div className="p-8 rounded-2xl border border-white/5 bg-[#090f0c] text-center text-xs text-[#e8e2d8]/60">
        ...
        <div className="pt-8 border-t border-white/10 text-xs text-[#e8e2d8]/50">
          <span>{t.blogPage.footerReviewedBy}</span>
        </div>
      </div>
