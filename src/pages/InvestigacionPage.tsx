...
export const InvestigacionPage: React.FC = () => {
  ...
  // Use localized metrics/lines if in English, or if default Spanish
  const displayMetrics = language === 'en' ? t.investigacionPage.metrics : metrics;
  const displayLines = language === 'en' ? t.investigacionPage.researchLines : researchLines;
      ...
      <div className="relative py-12 sm:py-16 md:py-20 px-5 sm:px-8 md:px-12 border-b border-emerald-950/40 bg-gradient-to-b from-[#0a130f] via-[#060a08] to-[#060a08]">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <span>{t.investigacionPage.backHome}</span>
          </Link>
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 md:px-12 py-12 sm:py-16 space-y-12 sm:space-y-16">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl sm:text-3xl font-serif text-white">
            {t.investigacionPage.linesHeading}
          </h2>
        ...
        <section className="p-8 rounded-2xl border border-white/10 bg-[#090f0c] space-y-6">
          <h2 className="text-xl sm:text-2xl font-serif text-white">
            {t.investigacionPage.methodologyHeading}
          </h2>
          <p className="text-sm text-[#e8e2d8]/80 leading-relaxed font-light">
            {t.investigacionPage.methodologyText}
          </p>
          <div className="pt-4 border-t border-white/5 flex items-center gap-4 text-xs text-[#e8e2d8]/60">
            <span>{t.investigacionPage.principalInvestigator}</span>
            <span>•</span>
            <span>{t.investigacionPage.focalSpecies}</span>
            <span>•</span>
            <span>{t.investigacionPage.location}</span>
          </div>
        </section>
