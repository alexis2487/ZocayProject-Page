    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <img
          ...
          alt="Mono Socai (Plecturocebus ornatus) en el dosel del bosque del Meta, Colombia"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-32 pb-24">
        <div className="max-w-2xl">
          ...
          {/* Short Subtitle / Brief Description */}
          <p className="text-base sm:text-lg text-[#e8e2d8]/80 font-sans font-light leading-relaxed max-w-xl mb-10">
            Ciencia, naturaleza y acción. Una iniciativa de investigación a largo plazo para comprender y proteger al mico zocay y la biodiversidad en los paisajes fragmentados de los Llanos Orientales de Colombia.
          </p>
          ...
          <div className="mt-14 pt-6 border-t border-white/10 flex flex-wrap items-center gap-6 text-xs text-[#e8e2d8]/60">
            ...
            <div className="italic font-serif text-[#e8e2d8]/75">
              Plecturocebus ornatus (Callicebus ornatus)
            </div>
          </div>
        </div>
      </div>
